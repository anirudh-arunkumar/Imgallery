const API_URL = "https://qp3f5v8yh3.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-arunkumar-2022-4150";
...
function deletePhoto(){
    ...
    $.ajax({
        ...
        200: function(data) {
            console.log(data);
            console.log("Deleted");
            processDeletePhoto(filename, title, description, tags);
         }
        },       
        data: imageFile
    }); 
...
function searchPhotos(){
    ...
    console.log(datadir);
    var URL = `https://qp3f5v8yh3.execute-api.us-east-1.amazonaws.com/dev`
...
function processDeletePhoto(filename, title, description, tags){
    var username = sessionStorage.getItem('username');    
    var uploadedFileURL = `https://${PHOTOGALLERY_S3_BUCKET_URL}.s3.amazonaws.com/photos/${filename}`;
